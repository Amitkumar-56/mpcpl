  ...
  const getStatusBadge = (status) => {
    ...
    if (typeof status === 'string') {
      const statusMap = {
        ...
        'reported': { label: 'Reported', color: 'bg-yellow-100 text-yellow-800' },
        'delivered': { label: 'Delivered', color: 'bg-green-100 text-green-800' },
        'unloaded': { label: 'Unloaded', color: 'bg-purple-100 text-purple-800' },
        'processing': { label: 'Processing', color: 'bg-blue-100 text-blue-800' },
        'completed': { label: 'Completed', color: 'bg-green-100 text-green-800' },
        'dispatched': { label: 'Dispatched', color: 'bg-yellow-100 text-yellow-800' },
      };
      
      const statusInfo = statusMap[status?.toLowerCase()] || { label: status || 'Unknown', color: 'bg-gray-100 text-gray-800' };
    ...
    const statusMap = {
      0: { label: 'Pending', color: 'bg-gray-100 text-gray-800' },
      ...
      4: { label: 'On the Way', color: 'bg-blue-100 text-blue-800' },
      5: { label: 'Reported', color: 'bg-yellow-100 text-yellow-800' },
      6: { label: 'Delivered', color: 'bg-green-100 text-green-800' },
      7: { label: 'Unloaded', color: 'bg-purple-100 text-purple-800' },
    };
    
    const statusInfo = statusMap[parseInt(status)] || { label: 'Unknown', color: 'bg-gray-100 text-gray-800' };
