                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="relative">
                    ...
                    {errors.licence_plate && (
                      <p className="mt-1 text-sm text-red-600">{errors.licence_plate}</p>
                    )}
                    {vehicleLoading && (
                    ...
                    {vehicles.length > 0 && (
                      <div className="absolute top-full left-0 right-0 mt-1 border border-gray-300 rounded-md bg-white shadow-lg max-h-40 overflow-y-auto z-10">
