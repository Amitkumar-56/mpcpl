...
async function handleCompletedStatus(data) {
  ...
  // ✅ REMOVED: Inward entry creation - Only Outward entry should be created on completion
  // Only Outward entry with customer details is inserted when status is completed
