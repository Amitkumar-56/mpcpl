        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 sm:space-x-0">
              ...
              {employeeProfile ? (
                <div className="bg-green-50 px-3 sm:px-4 py-2 rounded-lg border border-green-200 shadow-sm">
                  <span className="text-xs sm:text-sm font-medium text-green-700 flex items-center">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-2"></span>
                    ✅ {employeeProfile.name}
                  </span>
                </div>
              ) : (
                <div className="bg-red-50 px-3 sm:px-4 py-2 rounded-lg border border-red-200 shadow-sm">
                  <span className="text-xs sm:text-sm font-medium text-red-700 flex items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 text-sm sm:text-base border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                >
              ...
              {/* Loading Station */}
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Loading Station</label>
                <select
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-2 sm:space-x-2">
                <button
                  ...
                  className="flex-1 sm:flex-none px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 transition-colors text-sm sm:text-base"
                >
                  Filter
                </button>
                <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
            <div className="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-3 sm:p-4 shadow-sm">
              <div className="text-xs sm:text-sm font-medium text-gray-600">Total Quantity (Filtered)</div>
              <div className="text-xl sm:text-2xl font-bold text-blue-600">{totals.grandTotalQty.toFixed(2)}</div>
              <div className="text-xs text-gray-500">Showing: {totals.pageQty.toFixed(2)} (This Page)</div>
            </div>
            
            <div className="bg-green-50 border-l-4 border-green-500 rounded-lg p-3 sm:p-4 shadow-sm">
              <div className="text-xs sm:text-sm font-medium text-gray-600">Total Amount (Filtered)</div>
              <div className="text-xl sm:text-2xl font-bold text-green-600">₹{totals.grandTotalAmount.toFixed(2)}</div>
              <div className="text-xs text-gray-500">Showing: ₹{totals.pageAmount.toFixed(2)} (This Page)</div>
            </div>
            
            <div className="bg-purple-50 border-l-4 border-purple-500 rounded-lg p-3 sm:p-4 shadow-sm">
              <div className="text-xs sm:text-sm font-medium text-gray-600">Total Records (Filtered)</div>
              <div className="text-xl sm:text-2xl font-bold text-purple-600">{totals.grandTotalRecords}</div>
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Check</th>
                    <th className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Invoice</th>
                ...
                data.records.map((record, index) => (
                  <div
                    ...
                    className={`bg-white border rounded-lg p-4 shadow-sm ${
                      ...
                      invoicedRecords.has(record.id) ? 'border-r-4 border-r-purple-500 bg-purple-50' : ''
                    }`}
                  >
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">{record.product_name}</p>
                        </div>
                        <div>
                          <p className="text-xs font-medium text-gray-500">Station</p>
                          <p className="text-sm text-gray-900">{record.station_name}</p>
                        </div>
                        <div>
